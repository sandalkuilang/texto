...
namespace GSMCommunication.PDUDecoder
{
	public class SmsSubmitPdu : OutgoingSmsPdu
	{
		...
		/// </summary>
		/// <remarks>
		/// <para>When setting the property also the <see cref="P:GSMCommunication.PDUDecoder.SmsSubmitPdu.DestinationAddressType" />
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="T:GSMCommunication.PDUDecoder.SmsSubmitPdu" /> class using the specified text,
		...
		/// <see cref="F:GSMCommunication.PDUDecoder.DataCodingScheme.NoClass_7Bit" /> for GSM default alphabet and
		/// <see cref="F:GSMCommunication.PDUDecoder.DataCodingScheme.NoClass_16Bit" /> for UCS2 alphabet (Unicode).</para></remarks>
		...
		/// </summary>
		/// <returns>Always <see cref="F:GSMCommunication.PDUDecoder.SmsTimestamp.None" />. An <see cref="T:GSMCommunication.PDUDecoder.SmsSubmitPdu" /> does not have
		/// a timestamp.</returns>
