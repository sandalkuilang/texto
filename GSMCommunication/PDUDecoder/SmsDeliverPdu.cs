...
namespace GSMCommunication.PDUDecoder
{
	public class SmsDeliverPdu : IncomingSmsPdu
	{
		...
		/// </summary>
		/// <remarks>
		/// <para>When setting the property, also the <see cref="P:GSMCommunication.PDUDecoder.SmsDeliverPdu.OriginatingAddressType" /> property
		...
		/// <summary>
		/// Initializes a new <see cref="T:GSMCommunication.PDUDecoder.SmsDeliverPdu" /> instance using default values.
		/// </summary>
		...
		/// </summary>
		/// <returns>An <see cref="T:GSMCommunication.PDUDecoder.SmsTimestamp" /> containing the SMSC timestamp,
