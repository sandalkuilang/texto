...
namespace GSMCommunication.PDUDecoder
{
	public abstract class IncomingMessageFlags
	{
		...
		/// <summary>
		/// In derived classes, converts the specified <see cref="T:System.Byte" /> value into a new instance of the <see cref="T:GSMCommunication.PDUDecoder.IncomingMessageFlags" /> class.
		/// </summary>
