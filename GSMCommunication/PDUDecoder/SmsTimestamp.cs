...
namespace GSMCommunication.PDUDecoder
{
	public struct SmsTimestamp : IComparable
	{
		...
		/// consider using <see cref="P:GSMCommunication.PDUDecoder.SmsTimestamp.TimeZoneOffsetSpan" /> instead.</remarks>
		...
		/// </list>
		/// </returns>
		/// <exception cref="T:System.ArgumentException">value is not an <see cref="T:GSMCommunication.PDUDecoder.SmsTimestamp" />.</exception>
		...
		/// offset. If you just need the string representation, consider using the <see cref="M:GSMCommunication.PDUDecoder.SmsTimestamp.ToString" />,
		/// <see cref="M:GSMCommunication.PDUDecoder.SmsTimestamp.ToString(System.Boolean)" /> or <see cref="M:GSMCommunication.PDUDecoder.SmsTimestamp.ToSortableString" /> methods instead.
		/// </para>
		/// <para>
		/// An <see cref="T:GSMCommunication.PDUDecoder.SmsTimestamp" /> saves its years only with two digits by design, <see cref="T:System.DateTime" />
		/// uses 4 digits. The following conversion is performed when converting from an
		/// <see cref="T:GSMCommunication.PDUDecoder.SmsTimestamp" /> to a <see cref="T:System.DateTime" />: If the year is equal or greater than 90,
		...
		/// If you just want to display the value, consider using the <see cref="M:GSMCommunication.PDUDecoder.SmsTimestamp.ToString" /> or
		/// <see cref="M:GSMCommunication.PDUDecoder.SmsTimestamp.ToString(System.Boolean)" /> methods instead.</remarks>
		...
		/// <see cref="M:GSMCommunication.PDUDecoder.SmsTimestamp.ToSortableString" /> instead.
		/// </remarks>
