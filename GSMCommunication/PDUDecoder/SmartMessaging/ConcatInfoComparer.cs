...
/// <summary>
/// Implements a method to compare <see cref="T:GSMCommunication.PDUDecoder.SmartMessaging.IConcatenationInfo" /> objects.
/// </summary>
...
namespace GSMCommunication.PDUDecoder.SmartMessaging
{
    public class ConcatInfoComparer : IComparer<IConcatenationInfo>
    {
        ...
        /// <summary>
        /// Compares two <see cref="T:GSMCommunication.PDUDecoder.SmartMessaging.IConcatenationInfo" /> objects and returns a value indicating whether one is less than, equal to, or greater than the other. 
        /// </summary>
        ...
        /// </returns>
        /// <remarks>
        /// <para>This method provides a sort order comparison for type <see cref="T:GSMCommunication.PDUDecoder.SmartMessaging.IConcatenationInfo" />.</para>
