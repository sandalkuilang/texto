...
namespace GSMCommunication.PDUDecoder
{
	public class GeneralDataCoding : DataCodingScheme
	{
		...
		/// <summary>
		/// Determines if the <see cref="P:GSMCommunication.PDUDecoder.GeneralDataCoding.MessageClass" /> property has a message class meaning. If not,
		/// the <see cref="P:GSMCommunication.PDUDecoder.GeneralDataCoding.MessageClass" /> property contains a reserved value and has no message class meaning.
		/// </summary>
