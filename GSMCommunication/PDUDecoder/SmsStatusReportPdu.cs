...
namespace GSMCommunication.PDUDecoder
{
	public class SmsStatusReportPdu : IncomingSmsPdu
	{
		...
		/// </summary>
		/// <remarks>
		/// <para>When setting the property, also the <see cref="P:GSMCommunication.PDUDecoder.SmsStatusReportPdu.RecipientAddressType" /> property
		...
		/// </summary>
		/// <returns>An <see cref="T:GSMCommunication.PDUDecoder.SmsTimestamp" /> containing the discharge time, the timestamp where
