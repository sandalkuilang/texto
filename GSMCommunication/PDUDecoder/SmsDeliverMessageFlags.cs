...
namespace GSMCommunication.PDUDecoder
{
	public class SmsDeliverMessageFlags : IncomingMessageFlags
	{
		...
		/// </summary>
		/// <remarks>Always returns <see cref="F:GSMCommunication.PDUDecoder.IncomingMessageType.SmsDeliver" />.</remarks>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="T:GSMCommunication.PDUDecoder.SmsDeliverMessageFlags" /> class.
		/// </summary>
