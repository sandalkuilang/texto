...
namespace GSMCommunication.PDUDecoder
{
	public struct MessageStatus
	{
		...
		/// </summary>
		/// <remarks>
		/// If the valus does not fall into one of the predefined categories, <see cref="F:GSMCommunication.PDUDecoder.StatusCategory.Reserved" />
		/// is returned.
		/// </remarks>
		...
		/// </summary>
		/// <returns>Ae <see cref="T:GSMCommunication.PDUDecoder.KnownMessageStatus" /> representing the message status.</returns>
		/// <remarks>Check first with <see cref="M:GSMCommunication.PDUDecoder.MessageStatus.IsKnownStatus" /> before calling this method.</remarks>
