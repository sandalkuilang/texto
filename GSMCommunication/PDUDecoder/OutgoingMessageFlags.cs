...
namespace GSMCommunication.PDUDecoder
{
	public abstract class OutgoingMessageFlags
	{
		...
		/// <summary>
		/// In derived classes, converts the specified <see cref="T:System.Byte" /> value into a new instance of the <see cref="T:GSMCommunication.PDUDecoder.OutgoingMessageFlags" /> class.
		/// </summary>
